...
const projectDescription =
    <div>
        ...
        <div className={GeneralStyles.white}>
            ...
            <br />
            <p>
                This allows me to slowly introduce the mechanics without overwhelming the player. This led to an idea for <Link to={PageRouteData.LEMPath} onClick={OnClickNewSite}>LEM</Link> (Linear Effect Manager) which allows me to sequence events in order to make Tutorial making a lot easier.
            </p>
            <br />
            <p>
