...
import {  PageDescriptContent_downloadSection } from "../../../../../Data/PageData/ProjectPage/SubProjectPages/DragAndPull/PageDescriptionContent";
//#endregion

//#region *************** Side By Side Info *****************
import SideBySideContent_GameDescription from "../../../../../Data/PageData/ProjectPage/SubProjectPages/DragAndPull/SideBySideInfo_GameDescription";
import SideBySideContent_ProjectDescription from "../../../../../Data/PageData/ProjectPage/SubProjectPages/DragAndPull/SideBySideInfo_ProjectDescription";
//#endregion

//#region *************** Static Background *********************
import {staticBgContent} from "../../../../../Data/PageData/ProjectPage/SubProjectPages/DragAndPull/StaticBackgroundContent";
//#endregion
...
export default function PageContent()
{
    ...
    let heroPageTitle =
        <div className={styles.heroParent}>
            ...
            {/* <div className={`${columnStyle.col_desktop_6} ${columnStyle.col_tablet_6} ${columnStyle.col_mobile_10}`}></div> */}
            {/* <div className={`${columnStyle.col_desktop_3} ${columnStyle.col_tablet_3} ${columnStyle.col_mobile_1}`}></div> */}
        </div>
        ;
